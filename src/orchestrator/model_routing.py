...
ROLE_CATEGORY: dict[AgentRole, AgentCategory] = {
    ...
    AgentRole.MCP_TOOL_DESIGNER: AgentCategory.CODING,
    AgentRole.MCP_SERVER_ENGINEER: AgentCategory.CODING,
    AgentRole.MCP_PROTOCOL_REVIEWER: AgentCategory.VERIFICATION,
    AgentRole.MCP_INTEGRATION_TEST_ENGINEER: AgentCategory.VERIFICATION,
    AgentRole.CHATBOT_ENGINEER: AgentCategory.CODING,
    AgentRole.SOCIAL_MEDIA_INTEGRATION_ENGINEER: AgentCategory.CODING,
    AgentRole.DATA_ENGINEER: AgentCategory.CODING,
    AgentRole.RESILIENCE_TESTER: AgentCategory.VERIFICATION,
    AgentRole.CHANGE_IMPACT_ANALYZER: AgentCategory.VERIFICATION,
    AgentRole.FINOPS_ESTIMATOR: AgentCategory.LIGHTWEIGHT,
    AgentRole.RUNBOOK_AUTHOR: AgentCategory.LIGHTWEIGHT,
    AgentRole.REFACTORING_PLANNER: AgentCategory.PLANNING,
    # Verification / Review
